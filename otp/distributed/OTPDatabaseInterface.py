...
class OTPDatabaseInterface:
    """
    This class is part of Panda3D's new MMO networking framework.
    It interfaces with the OTP's database(s) to manage objects directly.

    Do not create this class directly; instead, use OTPInternalRepository's
    dbInterface attribute.
    """
    notify = DirectNotifyGlobal.directNotify.newCategory("OTPDatabaseInterface")
