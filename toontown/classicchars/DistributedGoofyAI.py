...
class DistributedGoofyAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def enterLonely(self):
        self.lonely.enter()
        self.acceptOnce(self.lonelyDoneEvent, self._DistributedGoofyAI__decideNextState)
    ...
    def enterChatty(self):
        self.chatty.enter()
        self.acceptOnce(self.chattyDoneEvent, self._DistributedGoofyAI__decideNextState)
    ...
    def enterWalk(self):
        self.notify.debug('going for a walk')
        self.walk.enter()
        self.acceptOnce(self.walkDoneEvent, self._DistributedGoofyAI__decideNextState)
