...
class PurchaseManagerAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def __init__(self, air, playerArray, mpArray, previousMinigameId, trolleyZone, newbieIdList = [], votesArray = None, metagameRound = -1, desiredNextGame = None, newbieId = None):
    ...
    def startCountdown(self):
        if not config.GetBool('disable-purchase-timer', 0) and not self.ownedNewbieId:
    ...
    def setInventory(self, blob, newMoney):
        avId = self.air.getAvatarIdFromSender()
