...
class DistributedToonAI(DistributedPlayerAI.DistributedPlayerAI, DistributedSmoothNodeAI.DistributedSmoothNodeAI, PetLookerAI.PetLookerAI):
    ...
    def setWhisperFrom(self, fromId, msg):
        self.sendUpdate('setWhisperFrom', [fromId, msg])

    def setWhisperQTFrom(self, fromId, qtSequence):
        self.sendUpdate('setWhisperQTFrom', [fromId, qtSequence])

    def setWhisperQTQuestFrom(self, fromId, qtSequence):
        self.sendUpdate('setWhisperQTQuestFrom', [fromId, qtSequence])

    def setWhisperQTCustomFrom(self, fromId, messageIndex):
        self.sendUpdate('setWhisperQTCustomFrom', [fromId, messageIndex])
    ...
    def teleportResponse(self, fromAvId, available, shardId, hoodId, zoneId):
        ...
        self.air.friendManager.teleportResponse(self.doId, fromAvId, available,
