...
# This is also the Toontown Test 2012 sets of HQnpcFriends and FOnpcFriends. Also making them the closet to the final sets known to exist.
# With custom SOS editions of course.
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK, 5, ToontownGlobals.MaxHpLimit, 5), #Flippy
                ...
                91917: (ToontownBattleGlobals.SOUND_TRACK, 0, 255, 5), # Magic Cat (From TTI)
                91918: (ToontownBattleGlobals.SOUND_TRACK, 6, 1,0), # Trap Cat (From TTI)
