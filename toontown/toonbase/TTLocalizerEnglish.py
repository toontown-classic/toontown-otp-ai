...
QuestsDefaultIncompleteProgress = ('You came to the right place, but you need to finish your ToonTask first.', 
 'When you are finished with that ToonTask, come back here.', 'Come back when you are finished with your ToonTask.')
QuestsDefaultIncompleteWrongNPC = ('Nice work on that ToonTask. You should go visit _toNpcName_._where_', 
 'Looks like you are ready to finish your ToonTask. Go see _toNpcName_._where_.', 'Go see _toNpcName_ to finish your ToonTask._where_')
...
QuestsCogNewNewbieQuestObjective = 'Help Toons with %d laff points or less defeat %s'
QuestsCogNewNewbieQuestCaption = 'Help a new Toon %d laff or less'
QuestsCogOldNewbieQuestObjective = 'Help Toons with %d laff points or less defeat %s'
QuestsCogOldNewbieQuestCaption = 'Help a new Toon %d laff or less'
...
ResistanceEmote1 = NPCToonNames[2001] + ': Welcome to the Resistance!'
ResistanceEmote2 = NPCToonNames[2001] + ': Use your new emote to identify yourself to other members.'
ResistanceEmote3 = NPCToonNames[2001] + ': Good luck!'
...
PolarPlaceEffect1 = NPCToonNames[2001] + ': Welcome to Polar Place!'
PolarPlaceEffect2 = NPCToonNames[2001] + ': Try this on for size.'
PolarPlaceEffect3 = NPCToonNames[2001] + ': Your new look will only work in ' + lTheBrrrgh + '.'
GreenToonEffectMsg = NPCToonNames[2001] + ': You look Toontastic in green!'
