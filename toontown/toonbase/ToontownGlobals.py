...
MinigamePlayerMatrix = {
    1: (CannonGameId, MazeGameId, TugOfWarGameId, RingGameId, CatchGameId),
    2: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, TagGameId, RingGameId, CatchGameId),
    3: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, RaceGameId, TagGameId, RingGameId, CatchGameId),
    4: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, RaceGameId, TagGameId, RingGameId, CatchGameId),
}
